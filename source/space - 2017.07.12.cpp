...
void calculateAcceleration(Particle entity1, Particle entity2, int precise = 0){
	...
	cout << entity1.getAccIndex(0) + gravitation*(entity2.getPosIndex(0) - entity1.getPosIndex(0)) << "\t"
	     << entity1.getAccIndex(1) + gravitation*(entity2.getPosIndex(1) - entity1.getPosIndex(1)) << "\t"
	     << entity1.getAccIndex(2) + gravitation*(entity2.getPosIndex(2) - entity1.getPosIndex(2)) << endl;

	//cout << radialNorm << "\t" << gravitation << endl;
	
	//entity1.setAcceleration(entity1.getAccIndex(0) + gravitation*(entity2.getPosIndex(0) - entity1.getPosIndex(0)), entity1.getAccIndex(1) + gravitation*(entity2.getPosIndex(1) - entity1.getPosIndex(1)), entity1.getAccIndex(2) + gravitation*(entity2.getPosIndex(2) - entity1.getPosIndex(2)));
}
...
int main(void){
	...
	*/
	...
	double *thing = entity[0].accelerationVector();
	cout << thing[0] << "\t" << thing[1] << "\t" << thing[2] << endl;
    cout << endl;
	...
	double *thang = entity[0].accelerationVector();
	cout << thang[0] << "\t" << thang[1] << "\t" << thang[2] << endl;
    cout << endl;
